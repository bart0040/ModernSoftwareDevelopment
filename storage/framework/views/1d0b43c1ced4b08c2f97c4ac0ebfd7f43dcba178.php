<?php $__env->startSection('content'); ?>
    ...
    <div class="text" style="background-color:white">
        ...
        <p><img src="<?php echo e(asset('healthyregion.jpg')); ?>"> </p>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\31641\Documents\GitHub\HealthyRegion\resources\views/welcome.blade.php ENDPATH**/ ?>